...
<td>
<form:input path="fname" required="required"></form:input>
</td>
</tr>
...
<td>
<form:radiobutton path="fgender" value="Male" required="required"/>Male
<form:radiobutton path="fgender" value="Female" required="required"/>Female
</td>
</tr>
...
<td><form:input path="fsalary" value="0.00" required="required"/></td>
</tr>
...
<td><form:input path="flocation" required="required"/></td>
</tr>
...
<td><form:input path="fmailid" required="required"/></td>
</tr>
...
<td><form:input path="fusername" required="required"/></td>
</tr>
...
<td><form:password path="fpassword" required="required"/></td>
</tr>
...
<td><form:input path="fcontactno" required="required"/></td>
</tr>
