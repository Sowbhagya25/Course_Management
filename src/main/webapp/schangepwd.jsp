...
<h1 align=center>Course Mangement System</h1>

<br>

<ul>
  <li><a href="studenthome">Home</a></li>
  <li><a class="active" href="schangepwd">Change Password</a></li>
...
<form method="post" action="updatespwd">
...
<style>
body {
  background-image: url('images/lms1.jpg');
